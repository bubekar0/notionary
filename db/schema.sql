...
CREATE TABLE `aanotion` (
  ...
  KEY `userID` (`userID`),
  KEY `notion` (`notion`)
) ENGINE=MyISAM AUTO_INCREMENT=1829 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=6925 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `foople nation notion`
--

DROP TABLE IF EXISTS `foople nation notion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `foople nation notion` (
...
--
-- Table structure for table `new goople`
--

DROP TABLE IF EXISTS `new goople`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `new goople` (
  `question` char(100) COLLATE utf8mb3_bin NOT NULL,
  `answer` char(100) COLLATE utf8mb3_bin NOT NULL,
  PRIMARY KEY (`question`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
-- Dump completed on 2026-07-01 13:14:36
