...
function f_l46(contents){
   var DURATION = 3000,
       thenotiz = document.createElement("div");
                  ...
                  thenotiz.innerHTML = "<div class='c_q38'>" + contents + "</div>";
...
function f_n47(contents){
   var offnotiz,
       thenotiz = document.createElement("div");
                  ...
                  thenotiz.setAttribute("class","animated fadeInDown");
                  thenotiz.innerHTML = 
                     "<div class='c_q38'>" + contents + "</div>" +
                     "<div class='c_f55 fa fa-times' id='i_175'></div>";
   document.body.insertBefore(thenotiz,document.body.firstChild);
   offnotiz = document.getElementById( "i_175" );
...
function f_y48(warne,jaBtn,noBtn,jaCBK,noCBK){
   var jabutton, nobutton,
       ...
       thenotiz.setAttribute("class","animated fadeInDown");
       thenotiz.innerHTML = 
          "<div class='c_q38'>" + warne + "</div>" +
          "<button id='i_q39'><span class='fa fa-hand-paper-o'></span>" + noBtn + "</button>" +
          "<button id='i_k40'><span class='fa fa-trash'></span>" + jaBtn + "</button>";

   document.body.insertBefore( thenotiz,document.body.firstChild );
   jabutton = document.getElementById( "i_q39" );
   nobutton = document.getElementById( "i_k40" );
...
function f_o49(markup,exitCBK){
   ...
   f_l23(overlay,1000);
   exiter = document.getElementById( "i_w161" );
...
function f_x50(ident,markup,bindCBK,exitCBK){
   ...
   themodal.innerHTML = 
      "<div        class='c_l37' id='" + ident + "ModalHold'>" +
         "<div     class='c_f55 fa fa-times'     id='" + ident + "ZentralExit'></div>" +
         "<div     class='c_o68' id='" + ident + "ZentralHold' onclick='function doNothing(){}'>" +
            "<span class='c_k39' id='" + ident + "ZentralLogo'>" + HARDCODE.myenv + "</span>" +
            "<div  class='c_k46' id='" + ident + "ZentralInfo'></div>" +
            "<div  class='c_n48' id='" + ident + "ZentralUser'></div>" +
            markup +
         "</div>" +
      "</div>";
...
function f_z51(ident,lineas,columnas,defText){
   return(
      "<div            id='" + ident + "CommentHolder'   class='c_i63'>" +
         "<span        id='" + ident + "CommentExiter'   class='c_f55 fa fa-times'></span>"+
         "<div         id='" + ident + "CommentFeedback' class='c_z52'></div>"+
         "<textarea    id='" + ident + "CommentTextarea' class='c_i61 notionary-dormant'" +
            " rows='" + lineas + "' cols='" + columnas+"'>" + defText +
         "</textarea>" +
         "<div         id='" + ident + "CommentButtons'  class='c_n64'>" +
             "<span    id='" + ident + "CommentCounter'  class='c_a60'></span>" +
             "<span    id='" + ident + "CommentSubmit'   class='c_j62 fa fa-paper-plane'"+
...
function f_j54(my_Id,deftxt){
   ...
   my_Id.classList.remove("c_h54");
   my_Id.classList.add("c_b57");
...
function f_l55(my_Id,deftxt){
   ...
   my_Id.classList.remove("c_b57");
   my_Id.classList.add("c_h54");
...
function f_a56(inits,usevalue,nolabels,uniqueid){
   ...
   return("<fieldset id='" + uniqueid + "nom' class='c_t51'>" +
            "<legend id='" + uniqueid + "leg' class='c_j41'>" + TRANSLAT[inits+"txt"] + "</legend>" +
             "<span  id='" + uniqueid + "txt' class='c_k25'>" + thelabel + "</span>" +
             "<span  id='" + uniqueid + "ajx' class='c_h40'></span>" +
             "<input id='" + uniqueid + "inp' class='c_q59 c_h54' " +
                 " type='" + inputype + "'    value='" + thevalue + "'/>" +
             "<span  id='" + uniqueid + "stg' class='c_d65'></span>" +
          "</fieldset>");
}
function f_e57(inits,olist,dbval,quiet){
   ...
   return("<span id='" + inits + "nom' class='c_z45'>" +
             "<span   id='" + inits + "txtSelect' class='c_k25'>" + texto + "</span>" +
             "<select id='" + inits + "sel' class='c_h32'>" + optionsString + "</select>" +
          "</span>");
}
function f_o58(inits,rlist,torf){
   ...
   return("<fieldset  id='" + inits + "nom' class='c_t51'>" +
             "<legend id='" + inits + "leg' class='c_j41'>" + TRANSLAT[ inits + "txt" ] + "</legend>" +
             "<div>" + 
                "<div class='c_i16'>" + // Negative "false" "no" choice
...
function f_s60(theNode,thePercent,theFarbe){
   ...
   theNode.innerHTML = "<div id='i_r15'></div><svg id='snapPercentCircle'></svg>" ;
   spn = document.getElementById( "i_r15" );
...
function f_b61(nhold,tlang,cback){
   ...
   keysMarkup = "<span id='i_l6'>";
      for ( k in fcode ) // Create the string of buttons (with breaks) for User to push
         if ( k.substr(0,5) == "break" ) keysMarkup += "<br/>";
         else keysMarkup += "<button id='" + k + "' class='c_v49'>" + fcode[k] + "</button>";
   keysMarkup += "</span>";
   nhold.innerHTML = "<div id='i_s18'>" + keysMarkup + "</div>";
   f_l23 (nhold,1000);
   for ( k in fcode )
      if ( fcode[k] != "break" ) {
...
function f_z63(snode,lanAR,defla){
   var TONGS = {"en":"English ",    "de":"Deutsch ",    "es":"Español ",
       ...
       m ="<div id='" + snode + "LanguageContainer' class='c_d44'>"+
        "<select class='c_y42' id='" + snode + "LanguageSelect'>";
...
function f_p81(){
   var mainlogo = document.getElementById( "i_139" ),
       settings = document.getElementById( "i_l43" ),
       escritor = document.getElementById( "i_k47" ),
       thumbler = document.getElementById( "i_q71" ),
       anmelder = document.getElementById( "i_f143" ),
       exmelder = document.getElementById( "i_d46" );
   ...
   if ( f_11("coook") != "true" && !LOGGEDIN )
      f_o49(
         "<div>" +
            "<span id='i_o162'>" + TRANSLAT.cooky + "</span> " +
            "<span id='i_w161'><span class='fa fa-check'></span>" + TRANSLAT.ackno + "</span> " +
         "</div>",
         function(){ f_e12("coook","true",365); }
      );
}
function f_i82(){
   var settings = document.getElementById( "i_l43" ),
       escritor = document.getElementById( "i_k47" ),
       thumbler = document.getElementById( "i_q71" ),
       anmelder = document.getElementById( "i_f143" ),
       exmelder = document.getElementById( "i_d46" );
         ...
         f_70(function(){ if( USERINFO[0].nosnd ) PLAYABLE = false;
            ...
            f_h72( function(){
               f_f71( BROWSLAN, function(){ NAMESREG[4] = TRANSLAT.notre;
                  ...
                  f_i82();
                  switch ( tuner ) {
                     case 'suche': node = document.getElementById( "i_y138" );
                           f_r97();
...
function f_w84(){
   if ( !ROOTUSER ) return("");
   return("<div    id='i_i57' class='fa fa-bars' title='Вы можете получить это далеко, но не дальше'>" +
             "<div id='i_x49'></div>" +
          "</div>" +
          "<div    id='i_y56' class='c_n23'>" +
             "<div id='i_m67' class='c_g24'><span class='fa fa-flask'></span>        Beta Test     </div>" +
             "<div id='i_h66' class='c_g24'><span class='fa fa-bug'></span>          Server Info   </div>" +
             "<div id='i_j65' class='c_g24'><span class='fa fa-trash'></span>        Clean Caches  </div>" +
             "<div id='i_o58' class='c_g24'><span class='fa fa-clone'></span>        Media Cloner  </div>" +
             "<div id='i_t60' class='c_g24'><span class='fa fa-file-image-o'></span> Image Editor  </div>" +
             "<div id='i_k59' class='c_g24'><span class='fa fa-database'></span>     Image Purger  </div>" +
             "<div id='i_j52' class='c_g24'><span class='fa fa-headphones'></span>   Sound Editor  </div>" +
             "<div id='i_q51' class='c_g24'><span class='fa fa-music'></span>        Sound Purger  </div>" +
             "<div id='i_d50' class='c_g24'><span class='fa fa-user'></span>         User Editor   </div>" +
             "<div id='i_j53' class='c_g24'><span class='fa fa-microphone'></span>   Microphone    </div>" +
             "<div id='i_i61' class='c_g24'><span class='fa fa-map'></span>          Static GMaps  </div>" +
             "<div id='i_62' class='c_g24'><span class='fa fa-map-marker'></span>   Dynamic GMaps </div>" +
          "</div>");
}
function f_l85(){
   ...
   if ( SMARTFON )
                 mobihtml = "<div id='i_l43' class='fa fa-cog'></div>" + 
                            "<div id='i_k47' class='fa fa-pencil-square-o' title='" + TRANSLAT.creak + "'></div>" +
                            f_w84();

   else          deskhtml = "<div id='i_l43' class='fa fa-cog' title='" + TRANSLAT.prefs + "'></div>" +
                            "<div id='i_k47' class='fa fa-pencil-square-o' title='" + TRANSLAT.creak + "'></div>" +
                            f_w84();

   return("<div id='i_b178'></div>" +
          "<div          id='i_l141' onclick='function doNothing(){}'>" +
             "<div       id='i_140'>" +
                "<div    id='i_139' class='c_k39'>" + HARDCODE.myenv + "</div>" +  deskhtml +
                "<button id='i_f143'><span class='fa fa-sign-in'> </span>" + TRANSLAT.sigin + "</button>" +
                "<button id='i_d46'><span class='fa fa-sign-out'></span>" + TRANSLAT.logof + "</button>" +
             "</div>" +
             "<fieldset  id='i_q133' class='c_t51'>" +
               "<legend  id='i_g134' class='c_j41'></legend>" +
                "<span   id='i_g131' class='c_k25'></span>" +
                "<span   id='i_e136' class='c_h40'></span>" +
                "<input  id='i_d135' class='c_q59 c_h54'/>" +
                "<span   id='i_w132' class='c_d65'></span>" +
                "<button id='i_j137'></button>" +
             "</fieldset>" +
             "<div       id='i_n42'></div>" +
          "</div>" +
          "<div id='i_y138'></div>" +
          "<div id='i_q71'>" + mobihtml + "</div>" +
          "<div id='i_w142'></div>");
}
function f_g86(){
   f_i17();
...
function f_i87(){
   var x, supes, nquot, supid, markup = "",
       ...
       worker = document.getElementById( "i_y138" );
   ...
   for ( x=0; x < supers.length; x++ ) {
      ...
      markup +=
         '<div class="notionary-supernotion" super="' + supid +'" title="' + title + '" >' +
               "<div class='c_r8'>" + nquot +
                  "  ( " + supers[x].snots.split(",").length + " )  " +
               "</div>" +
               "<div class='c_w9'>" + supers[x].sdesc + "</div>" +
         "</div>";
   }
   ...
   for ( i = 0; i < supes.length; i++ )
      supes[i].onclick = function(e) { f_e105( this.getAttribute("super"), document.getElementById( "i_y138" ) ); }
}
...
/* FOOTER ROUTINES */
function f_t90(){
   var footer = document.getElementById("i_w142");
...
*/
         skfolg.innerHTML = "<a data-config='commands=*;size=14;status=off;" +
                                ...
                                " id='i_33' href='http://www.skaip.org/'>" +
...
function f_l91(){
   var shower, privacy;
   shower  = document.getElementById( "i_y138" );
             shower.innerHTML = "<div class='mudocu'><div id='i_a24'></div></div>";
   privacy = document.getElementById( "i_a24" );
   f_o43("mudoc");
...
function f_v92(){  // As opposed to f_z107() for account creation
   var shower, terminos;
   shower  = document.getElementById( "i_y138" );
             shower.innerHTML = "<div class='mudocu'><div id='i_g32'></div></div>";
   terminos = document.getElementById( "i_g32" );
   f_o43("mudoc");
...
function f_i93(){
   ...
   shower = document.getElementById( "i_y138" );
            shower.innerHTML = "<div class='mudocu'><div id='i_e36'></div></div>";
   guider = document.getElementById( "i_e36" );
...
function f_j94(){
   var shower, cooker;
   shower  = document.getElementById( "i_y138" );
             shower.innerHTML = "<div class='mudocu'><div id='i_o31'></div></div>";
   cooker = document.getElementById( "i_o31" );
   f_o43("mudoc");
...
function f_m95(){
   var shower, presser;
   shower  = document.getElementById( "i_y138" );
             shower.innerHTML = "<div class='mudocu'><div id='i_n17'></div></div>";
   presser = document.getElementById( "i_n17" );
   f_o43("mudoc");
...
function f_r97(){
   var suchfeld = document.getElementById( "i_d135" ),
       suchbttn = document.getElementById( "i_j137" );
...
function f_p106(){ // Placed here to give outsiders a chance to ask for this tool
   ...
   nakeNode = document.getElementById( "i_y138" );
   if ( !LOGGEDIN ) f_n47(TRANSLAT.logfn);
   else {
      inits = "qs";
      xm += "<div id='i_q119' class='c_z52'></div>";
      for ( THEINDEX = 0; THEINDEX < NINFDATA[1].qaimg.length; THEINDEX++){
         xm+="<div class='c_s31' id='" + THEINDEX + "'>" +
                "<span  class='c_d21'>" + THEINDEX + "</span>" +
      ...
      f_x39( document.getElementById( "i_q119"), "[" + NINFDATA[0].nname + "]", "radTang" );
      f_o43("recorder");
   ...
   f_n64("?tun=mudoc&was=terms").then(
      function( response ) {
         document.body.innerHTML = "<div style='width:80%;margin:0 auto;'>" + response +
                                      "<button id='i_i20'>" + TRANSLAT.agree + "</button>" +
                                   "</div>";
         agreeButton = document.getElementById( "i_i20" );
...
function f_w108(loginCBK,loginals){
   ...
   f_x50("signIn", 
      ...
      "<button   id='i_k173'>" + TRANSLAT.conti + "</button>" +        // Continue Button when Username is filled in
      "<button   id='i_q167'>" + TRANSLAT.sigin + "</button>" +        // Sign In Button when Username and Password filled in
      "<button   id='i_j174'>" + TRANSLAT.p2txt + "</button>" +        // Password Confirmation Button when New Password is filled in
      "<button   id='i_w165'>" + TRANSLAT.savit + "</button>" +        // Sign Up Button when Username and Password filled in
      "<a        id='i_f166'>" + TRANSLAT.sigup + "</a>" +
      "<a        id='i_e171'>" + TRANSLAT.i4got + "</a>"+
      "<div      id='i_l164'>" + "<input id='stickyChbx' type='checkbox'/>" + TRANSLAT.kenne + "</div>" +
      "<div      id='i_d169'>" +
         "<div   id='i_o172' title='" + TRANSLAT.sigfb + "' class='c_53'></div>" +
         "<div   id='i_p170' title='" + TRANSLAT.siggp + "' class='c_m47'></div>" +
         "<div   id='i_c163' title='" + TRANSLAT.sigtw + "' class='c_i19'></div>" +
      "</div>",
      function(){ // Bind Callback()
         ...
         contibtn = document.getElementById( "i_k173" );            confobtn = document.getElementById( "i_j174" );
         siginbtn = document.getElementById( "i_q167" );            sigupbtn = document.getElementById( "i_w165" );
         vergesen = document.getElementById( "i_e171" );            register = document.getElementById( "i_f166" );
         stickers = document.getElementById( "i_l164" );            autologs = document.getElementById( "stickyChbx" );
         facebook = document.getElementById( "i_o172" );            googling = document.getElementById( "i_p170" );
         tweeting = document.getElementById( "i_c163" );            quitting = document.getElementById( "signInZentralExit" );
...
function f_t110(supid){
   ...
   return( SERVINFO[3].supers[sidx].sname + 
      "<div class='c_b14'>" + TRANSLAT.creby +
            SERVINFO[3].supers[sidx].owner.kurzen( OWNERMAX ) +
         "<img src='" + creimg + "'/>" +
      "</div>" +
      "<span class='c_r75'>" + SERVINFO[3].supers[sidx].sdesc + "</span>");
}
function f_y111(nobj){
   ...
   if (nobj.chmp1 ) // Don't render Champion info unles there is one
      champ = "<div class='c_g67'>"+
                 ...
                 "</span>" +
              "</div>";
   return(nobj.nname + "<div class='c_b14'>" +
             "<span class='nnero'>" + TRANSLAT.creby + "</span>" +
             nobj.owner.kurzen( OWNERMAX ) + 
             "<img src='"+ imag0+"'/>"+
          "</div>" +
          pacar + myall +
          "<span class='c_r75'>" + nobj.ndesc + "</span>" +
          f_h112(nobj.revus));
}
   ...
   for ( x=0; x < keyAR.length; x++ ) {
      ...
      try { // For user records see UNIFO[1]; other cached files are empty or unreliable
         if ( f_q89( "nidno", keyAR[x].nidno, "mysc1") )
            percnt="<div class='c_q77'> 33%" + TRANSLAT.compl + "</div>";
         if ( f_q89( "nidno", keyAR[x].nidno, "mysc2") )
            percnt="<div class='c_q77'> 66%" + TRANSLAT.compl + "</div>";
         if ( f_q89( "nidno", keyAR[x].nidno, "mysc3") )
            percnt="<div class='c_q77'>100%" + TRANSLAT.compl + "</div>";
      } catch(err){};
      ...
      mu += '<div class="notionary-plainnotion" title="' + title +'" rname="' + nquot + '"'+
                  ...
                  " forja='" + keyAR[x].forja + "'>" +
               "<input type='checkbox' " +
                  " class='c_n66' title='" + TRANSLAT.multi + "' "+
                  ' nname="' + nquot + '"/>'+
               "<div class='c_c12'>" + nquot + "</div>" +
                  "<img class='c_k7' src='" + nisrc + "'/>" +
                  "<div class='c_d78'>" + TRANSLAT.total + keyAR[x].nsize + "</div>" +
                  sterne  + percnt ;
...
function f_p115(){
   ...
   kernNode = document.getElementById( "i_y138" );            
   ...
   mixnum   = document.getElementById( "i_m7" );
   ...
   chekers = document.getElementsByClassName( "c_n66" );
...
function f_x118(){
   var VIDOPTNS = "?start=5;?rel=0&amp;fs=1&amp;autoplay=1&amp;autohide=1"+
       ...
       VIDHOEHE = 400,
       mu = "", vlink, xampic;
   xampic = document.getElementById( "i_f77" );
...
function f_i120( testtype ){
   var barrotes = document.getElementById( "i_h90" ), timeleft = document.getElementById( "i_c80" ),
       xamqtext = document.getElementById( "i_l76" ), xamanser = document.getElementById( "i_c75" ),
       writings = document.getElementById( "i_q73" ), xamleven = document.getElementById( "i_q81" ),
       xamkbikn = document.getElementById( "i_k82" ), keyboard = document.getElementById( "i_m83" ),
   ...
   document.getElementById( "i_x87" ).onclick = function(e){ f_g86(); f_i87(); }
...
function f_m121( testtype, bindCBK ){
   ...
   document.body.innerHTML = 
      "<div          id='i_88'>" +
         "<div       id='i_b74'>" + kurzname + "</div>" +
                     learnbtn + trialbtn + writebtn + adeptbtn +
                     listabtn + lesenbtn + watchbtn + amendbtn +
         "<div       id='i_x87' class='fa fa-times'></div>" +
         "<div       id='i_h90'>" +
            "<div    id='i_y86'></div>" +
            "<div    id='i_t91'>" +
               "<div id='i_v92'><div id='examBadCount'></div></div>" +
               "<div id='i_r85'><div id='examGutCount'></div></div>" +
               "<div id='i_v79'><div id='examLrnCount'></div></div>" +
            "</div>" +
         "</div>" +
         "<div       id='i_c80'><div id='examLifeleft'></div></div>" +
      "</div>" +
      "<div          id='i_l89'>" +
         "<div       id='i_f77'></div>" +
         "<div       id='i_l76'></div>" +
         "<div       id='i_q73'>" +
            "<span   id='i_q81'></span>"+
            "<input  id='i_c75'>"+
            "<span   id='i_k82' class='fa fa-keyboard-o' title='" + TRANSLAT.fkeys + "'></span>" +
            "<div    id='i_m83'></div>" +
         "</div>" +
      "</div>" +
      "<div          id='i_m78'></div>";
...
function f_y123(testtype){
   ...
   switch( testtype ){
      case 'learn': f_m121( testtype, function (){ f_i120( testtype );
                       document.getElementById( "i_l89" ).innerHTML = f_v124( NINFDATA, "" );
                       f_h125();
                    }); break;
      case "lesen": f_m121( testtype, function(){ f_i120( testtype );
                       document.getElementById( "i_f77" ).innerHTML =
...
function f_v124(nobj,cards2show){
   ...
   tacky = "<div class='c_f55 fa fa-times'></div>";
   for ( card = 0; card < total; card++ ) {  // Generate a Flip-Card per QA Pair (Maybe Piction!)
      ...
      count = "<div class='c_e69'>" + parseInt(card+1) + "/" + WORKDATA.length + "</div>";
      frage = "<div class='c_r70'>" + theQ + "</div>";
      anser = "<div class='c_r70'>" + theA + "</div>";
      ...
      if ( nobj[0].picto ) { // Pictions MUST have an Image, and MAY have a Sound
         ...
         frage = "<img class='c_v34' src='" + HARDCODE.image + imgid + "'>" ;
      }

      mu += "<section class='c_w71' " + sound + "title='" + TRANSLAT.fover + "'>" +
               "<div class='c_v50' qaIndex='" + card + "'>" +
                  "<figure style='font:normal normal 600 " + qFont + "em/100% Futura,sans-serif,monospace;' " +
                         " class='c_n72'>" + count + tacky + frage +
                  "</figure>" +
                  "<figure style='font:normal normal 600 " + aFont + "em/100% Futura,sans-serif,monospace;' " +
                         " class='c_o73'>" + count + tacky + anser +
                  "</figure>" +
               "</div>" +
            "</section>";
   }
...
function f_h125(){
   ...
   tacos  = document.getElementsByClassName("c_f55");
   for ( i = 0; i < tacos.length; i++ )
      tacos[i].onclick = function( e ){
         ...
         document.getElementById( "i_v79" ).style.setProperty("width", ( 100 * ++learned / WORKDATA.length)  + "%");
   ...
   caras = document.getElementsByClassName( "c_n72" );
   ...
   backs = document.getElementsByClassName( "c_o73" );
...
function f_d127(talign,borde,msg,farbe){
   var xamfbk = document.getElementById( "i_y86" );
...
function f_t128(typed,anser,testtype){
   ...
   xamleven = document.getElementById( "i_q81" );
              if ( xamleven ) xamleven.style.visibility = "hidden";
   xamanser = document.getElementById( "i_c75" );
...
function f_n132(testtype){ // Watch out for "￭" Block separator
   ...
   mulxoices = document.getElementById( "i_m78" ); mulxoices.innerHTML = "";
   xamanser  = document.getElementById( "i_c75" );
   ...
   for ( i = 0; i < CHOIXMIN; i++ )                                // choices-1 randm + answer
      mulxoices.innerHTML += "<button id='reco" + i + "' class='c_k56'>" + rdmAR[i] + "</button>";
   xoibtns = document.getElementsByClassName( "c_k56" );
...
function f_n133(testtype){
   ...
   mulxoices   = document.getElementById( "i_m78" );
   xoice = WORKDATA[ THEINDEX ].q.substr(0,1); // first char=# choices or q=4
   if ( xoice == "q" ) xoice = 4;
   for ( i = 0; i < xoice; i++ )
      mu += "<button id='reco" + i + "' class='c_k56'>" +
...
function f_f134(testtype){
   ...
   xamanser  = document.getElementById( "i_c75" );
   xamqtext  = document.getElementById( "i_l76" );
   xampicto  = document.getElementById( "i_f77" );
   xamimage  = document.getElementById( "i_84" );
   ...
   if ( NINFDATA[0].picto && WORKDATA[ THEINDEX ].i ) {
      ...
      xampicto.innerHTML = "<img id='i_84' src='" + imsrc + "'>";
...
function f_e136(rottgrun){
   ...
   document.getElementById( "i_r85" ).style.setProperty("width",gutPercent + "%");
   if ( gutPercent > SHOWPCNT ) document.getElementById( "examGutCount" ).innerHTML = ( 100 * KORREKTE / WORKDATA.length ).toFixed(0) + "%";
   document.getElementById( "i_v92" ).style.setProperty("width",badPercent + "%");
...
function f_m138(){
   ...
   if ( msend ) msend.onclick = function(){
      ...
      temporaNode.innerHTML = "<span  class='c_f55 fa fa-times'></span>"+
                              "<div   class='c_z52'></div>" +
      ...
      { "nidno": NINFDATA[0].nidno, "ttype": testtype, "right": right,
        "score": score, "dauer": dauer, "probs": probs })).then(function( response ){
         if ( response ){ document.body.innerHTML = response;
            ...
            xamrestitle.setAttribute("class","c_z52");
            xamresoffer.classList.add("class","c_f55");
...
function f_f140(){
   ...
   if ( USERINFO[0].ulang != "en") enopt = "<div class='c_g24' spk='englis'><span class='notionary-englisch'></span> English   </div>";
   if ( USERINFO[0].ulang != "de") deopt = "<div class='c_g24' spk='german'><span class='notionary-tedeschi'></span> Deutsch   </div>";
   if ( USERINFO[0].ulang != "es") esopt = "<div class='c_g24' spk='spanis'><span class='notionary-spanisch'></span> Español   </div>";
   if ( USERINFO[0].ulang != "fr") fropt = "<div class='c_g24' spk='french'><span class='notionary-francais'></span> Français  </div>";
   if ( USERINFO[0].ulang != "it") itopt = "<div class='c_g24' spk='italia'><span class='notionary-italiano'></span> Italiano  </div>";
   if ( USERINFO[0].ulang != "pt") ptopt = "<div class='c_g24' spk='portug'><span class='notionary-portuges'></span> Português </div>";
   if ( USERINFO[0].ulang != "ru") ruopt = "<div class='c_g24' spk='russky'><span class='notionary-russians'></span> Pусский   </div>";
   if ( USERINFO[0].ulang != "hu") huopt = "<div class='c_g24' spk='magyar'><span class='notionary-magyarul'></span> Magyar    </div>";

   langhtml = document.getElementById( "i_a69" );
   langhtml.innerHTML = "<img id='i_d70' src='"+ HARDCODE.image + f_i62( USERINFO[0].ulang ) + "'/>" + 
      "<div id='i_f68' class='c_n23'>" + enopt + deopt + esopt + fropt + itopt + ptopt + ruopt + huopt + "</div>";

   flagclik = document.getElementById( "i_d70" ); // Clickable to shide or show the Menu
   flagmenu = document.getElementById( "i_f68" ); // Container of Flag Menu HTML
   flagclik.onclick = function(e){ if ( flagmenu.style.display == "block" ) f_z24(flagmenu,10,true); else f_l23(flagmenu); }

   vanderas = document.getElementsByClassName( "c_g24" );
...
function f_c143(){
   ...
   f_x50("profile",
      ...
      "<button id='i_e168'>" + TRANSLAT.savit + "</button>",
     function(){ // Binding Callback()
         f_f140();
         f_y142("i_d130",function(){ f_y151("av"); });
         ...
         saverbtn = document.getElementById( "i_e168" );
...
function f_q144(){
   ...
   if ( document.getElementById( "i_q116" ) )
      language = document.getElementById( "i_q116" ).getAttribute("tgetlang")
...
function f_y145(){
   var trophies = document.getElementById( "i_n42" );

   if ( USERINFO[0].kenne )
      trophies.innerHTML += "<div id='i_i48' class='c_f20'>" +
                               "<span class='fa fa-shield'></span>" +
                               "<div class='c_n58'>" + USERINFO[0].kenne + "</div>" +
                            "</div>";
   if ( USERINFO[0].wrote )
      trophies.innerHTML += "<div id='i_z41' class='c_f20'>" +
                               "<span class='fa fa-trophy'></span>" +
                               "<div class='c_n58'>" + USERINFO[0].wrote + "</div>" +
                            "</div>";
   if ( USERINFO[0].meist )
      trophies.innerHTML += "<div id='i_w45' class='c_f20'>" +
                               "<span class='fa fa-star'></span>" +
                               "<div class='c_n58'>" + USERINFO[0].meist + "</div>" +
                            "</div>";

   if ( f_a179() ) {
      trophies.innerHTML += "<div id='i_d44' class='c_f20' title='" + TRANSLAT.repas + "'>" +
                               "<span class='fa fa-thumbs-o-down'></span>" +
                               "<div class='c_n58'>" + f_a179() + "</div>" +
                            "</div>";
      document.getElementById( "i_d44" ).onclick = function(e) { window.location.href = HARDCODE.myurl + "?tun=probs"; }
   }
...
function f_p146(inits){
   return(
    "<div class='c_z29'>" +
      ...
      "<div    id='" + inits + "Spiner' class='c_g28'></div>" +
      ...
      "<span   id='" + inits + "Done'   class='c_v30'></span>" +
...
function f_c150(inits,nname,frage,sndid){
   ...
   listen = document.getElementById( inits + "Listen");
   recidx = document.getElementById( "i_k34" );
...
function f_y151(inits){
   ...
   switch(inits){
      ...
      case "ni": theTable = NINFDATA[0].nname,   theColumn = "",   theIndex = "";
                 hauptimg = document.getElementById( "i_b118" );
...
function f_y152( inits, imagenum, theTable, theColumn, theIndex ){
   ...
   if ( imagenum != 101 )
      delemkup = "<button id='i_z72' class='c_w82'>" +
                    "<span class='fa fa-trash'></span>" + TRANSLAT.delek +
                 "</button>";
   f_x50("imageHoch",
         "<div   id='" + inits + "pre'></div>" +
         "<div   id='" + inits + "php' class='c_t10'></div>" +
         delemkup,
      function(){
         ...
         if ( deletbtn = document.getElementById( "i_z72" ) )
                        ...
                        seter("aaimage","","DELETE","imageID",imagenum,function(){
                           ...
                           switch ( inits ) {
                              case "av": seter("aaavatar","","DELETE","userID",USERINFO[0].uidno,function(){});
                                         avatar = document.getElementById( "i_d130" );
            ...
            if( ulres.status === 0) { mediaID = ulres.db_id; mediaName = ulres.name;
               ...
               switch(inits){
                  case 'av': USERINFO[0].uimag = mediaID; USERBILD = imsrc;
                             ...
                             avhold = document.getElementById( "i_d130" );
                  ...
                  case 'qi': // 1) Update the extant Notion
                             ...
                             if ( camerikn = document.getElementById( idxvalue + "i" ) ) {
                                ...
                                theimage.setAttribute( "class", "c_e33");
...
function f_r155( inits, theTable, theColumn, theIndex, prevue ){
   ...
   phpNode.innerHTML =
      "<div class='c_y4'>"+
        "<form id='i_t177' sizno='" + MAXFS + "' action='" + HARDCODE.myurl + "usrindex.php' target='dummy' " +
           ...
           "<input  id='foo' class='c_z81' type='file' name='foo'/>" +
   ...
   formal = document.getElementById( "i_t177" );
...
function f_x156(){
   ...
   editrack = document.getElementById( "i_b97" );
...
function f_r160(nname,ndesc,namedesc,bindCBK){
   ...
   if ( namedesc == "name" ) {
      ndmarkup  = "<span  id='i_t107'>" + TRANSLAT.nname + "</span>";
      if ( nname ) defvalue = nname; else defvalue = TRANSLAT.nndef; 
      ndmarkup += "<input id='i_c106' value='" + defvalue + "'>";
      document.getElementById( "i_v108" ).innerHTML = ndmarkup;
   }
   if ( namedesc == "desc" ) {
      ndmarkup  = "<span  id='i_o110'>" + TRANSLAT.ndesc +
                     "<span  id='i_x111'></span>" +
                  "</span>";
      if ( ndesc ) defvalue = ndesc; else defvalue = TRANSLAT.nddef; 
      ndmarkup += "<input id='i_p109' value='" + defvalue + "'>";
      document.getElementById( "i_f112" ).innerHTML = ndmarkup;
   }
...
function f_q161(nname,bindCBK){
   var cbmarkup = "";
   cbmarkup += "<span id='i_t30'>" + TRANSLAT.dokum + "</span>" +
               "<input type='checkbox' id='i_q124'";
                  try { if ( NINFDATA[0].dokum ) cbmarkup += " checked "; } catch(err){}
   cbmarkup += "/>" +
               "<label id='i_t30' for='i_q124'>" + TRANSLAT.yeses + "</label>"+
               "<span id='i_j122'></span>";

   document.getElementById( "i_m123" ).innerHTML = cbmarkup;
   bindCBK();
}
function f_w162(){
   var dokumbox, dokumgui;
   dokumbox = document.getElementById( "i_q124" );
   dokumgui = document.getElementById( "i_j122" );

   if ( !dokumbox || !dokumgui ) return;

   handleDokum = function(){
      dokumgui.innerHTML = "<button id='i_d129'>" +
                              "<span class='fa fa-file-pdf-o'></span>" + TRANSLAT.uload +
                           "</button>";
      document.getElementById( "i_d129" ).onclick = function(e){
         f_x50("uploadPDF","<div class='c_t10' id='pdphp'></div>",
            function(){ 
...
function f_f163(nname,bindCBK){
   var cbmarkup = "";
   cbmarkup += "<span id='i_d27'>" + TRANSLAT.video + "</span>" +
               "<input type='checkbox' id='i_q96'";
                  try { if ( NINFDATA[0].video ) cbmarkup += " checked "; } catch(err){}
   cbmarkup += "/>" +
               "<label id='i_d27' for='i_q96'>" + TRANSLAT.yeses + "</label>"+
               "<span id='i_t94'></span>";

   document.getElementById( "i_c95" ).innerHTML = cbmarkup;
   bindCBK();
}
function f_e164(){
   ...
   videobox = document.getElementById( "i_q96" );
   videogui = document.getElementById( "i_t94" );

   if ( !videobox || !videogui ) return;

   handleVideo = function(){
      videogui.innerHTML = "<input id='i_h93' value='" + (NINFDATA[0].video ? NINFDATA[0].video : DEFYTUBE) + "'>";
      f_l23( videogui,10,"inline-block" );

      ytubeurl = document.getElementById( "i_h93" );
...
function f_b165(nname,bindCBK){
   var cbmarkup = "";
   cbmarkup += "<span id='i_l29'>" + TRANSLAT.picto + "</span>" +
               "<input type='checkbox' id='i_o105'";
                  try { if ( NINFDATA[0].picto ) cbmarkup += " checked "; } catch(err){}
   cbmarkup += "/>" +
               "<label id='i_l29' for='i_o105'>" + TRANSLAT.yeses + "</label>"+
               "<span id='i_a103'></span>";

   document.getElementById( "i_i104" ).innerHTML = cbmarkup;
   bindCBK();
}
function f_b166(){
   var i, pictobox, pictogui, camerons, imagenes, questext;

   pictobox = document.getElementById( "i_o105" );
   pictogui = document.getElementById( "i_a103" );
   camerons = document.getElementsByClassName("c_f74");
   imagenes = document.getElementsByClassName("c_e33");
...
function f_j167(nname,bindCBK){
   var cbmarkup = "";
   cbmarkup += "<span id='i_n28'>" + TRANSLAT.piece + "</span>" +
               "<input type='checkbox' id='i_m102'";
                  try { if ( NINFDATA[0].piece ) cbmarkup += " checked "; } catch(err){}
   cbmarkup += "/>" +
               "<label id='i_n28' for='i_m102'>" + TRANSLAT.yeses + "</label>"+
               "<span id='i_b100'></span>";

   document.getElementById( "i_r101" ).innerHTML = cbmarkup;
   bindCBK();
}
function f_l168(){
   var NPARTMAX = 10,
       i, compibox, piecegui, pcmarkup, partikel, cardinal;
   compibox = document.getElementById( "i_m102" );
   piecegui = document.getElementById( "i_b100" );

   if ( !compibox || !piecegui ) return;

   handlePiece = function(){
      pcmarkup = TRANSLAT.teile + "<select id='i_w37'>";
      ...
      pcmarkup += "</select></div>";
      pcmarkup += TRANSLAT.outof + "<select id='i_t38'>";
      for ( i = 1; i <= NPARTMAX; i++ ) {
         pcmarkup += "<option";
      ...
      partikel = document.getElementById( "i_w37" );
      cardinal = document.getElementById( "i_t38" );
...
function f_m170( deflingo ){
   ...
   enoption = "<div class='c_g24' language='en'><span class='notionary-englisch'></span> English   </div>";
   deoption = "<div class='c_g24' language='de'><span class='notionary-tedeschi'></span> Deutsch   </div>";
   esoption = "<div class='c_g24' language='es'><span class='notionary-spanisch'></span> Español   </div>";
   froption = "<div class='c_g24' language='fr'><span class='notionary-francais'></span> Français  </div>";
   itoption = "<div class='c_g24' language='it'><span class='notionary-italiano'></span> Italiano  </div>";
   ptoption = "<div class='c_g24' language='pt'><span class='notionary-portuges'></span> Português </div>";
   ruoption = "<div class='c_g24' language='ru'><span class='notionary-russians'></span> Pусский   </div>";
   huoption = "<div class='c_g24' language='hu'><span class='notionary-magyarul'></span> Magyar    </div>";

   langhtml = document.getElementById( "i_e115" );
   langhtml.innerHTML = "<img id='i_q116' title='" + TRANSLAT.tarla + "' " +
                           " tgetlang='"+ deflingo + "' " +
                           " src='"+ HARDCODE.image + f_i62( deflingo ) +
                        "'/>" +
                        "<div id='i_i114' class='c_n23'>" +
                           enoption + deoption + esoption + froption + 
                           itoption + ptoption + ruoption + huoption +
                        "</div>";

   flagclik = document.getElementById( "i_q116" ); // Clickable to shide or show the Menu
   flagmenu = document.getElementById( "i_i114" ); // Container of Flag Menu HTML
   flagclik.onclick = function(e){ if ( flagmenu.style.display == "block" ) f_z24(flagmenu,10,true); else f_l23(flagmenu); }
   ...
   for ( i = 0; i < vanderas.length; i++ )
      vanderas[i].onclick = function( e ){
         e.preventDefault();
         f_z24(flagmenu,10,true);
         document.getElementById( "i_q116" ).setAttribute("src", HARDCODE.image + f_i62( this.getAttribute("language") ) );
         document.getElementById( "i_q116" ).setAttribute("tgetlang",this.getAttribute("language") );
      }
}
function f_q171(qaiAR){
   var addonebtn = document.getElementById( "i_r120" ),
       qandafeld = document.getElementById( "i_h127" ),
       pictobox  = document.getElementById( "i_o105" ),
       basurita = "<div class='c_n76 fa fa-trash' title='" + TRANSLAT.dcard + "'></div>",
       contador, questext, resptext, ellipsis,
       camarita = cardimag = parlante = "";

   addonebtn.onclick = function() {
      contador = "<div class='c_e69'>" + parseInt( THEINDEX + 1 ) + "/" + parseInt( THEINDEX + 1 ) + "</div>",
      questext = "<textarea class='c_v26 notionary-pregunta' id='" + THEINDEX + "q'></textarea>",
      resptext = "<textarea class='c_v26 notionary-risposta' id='" + THEINDEX + "a'></textarea>",
      ...
      if ( ISEXTANT ) {
         ...
         cardimag = "<img class='c_e33' src='" + HARDCODE.image + 166 + "'>";
         parlante = "<div style='color:#E78F08' class='c_i27 fa fa-play' id='" +
                        THEINDEX + "s' title='" + TRANSLAT.rcord + "'>" +
                     "</div>";
         // IMAGES -->> Only Pictions can show images -- Make icons available in case Piction is desired
         camarita = "<div style='color:#E78F08' class='c_f74 fa fa-camera' id='" +
                        THEINDEX + "i' title='" + TRANSLAT.qitxt + "'>" +
                     "</div>";
      }

      qandafeld.innerHTML += "<section class='c_w71' id='" + THEINDEX + "'>" +
                                "<div  class='c_v50' qaIndex='" + THEINDEX + "'>" +
                                   "<figure class='c_n72'>" +
...
function f_y172(categ,nname,ndesc,tlang,qandatxt){
   var contador, questext, resptext, ellipsis, nimgzahl, deletion,
       ...
       uploader = "<div id='csphp' class='c_t10'></div>",
       basurita = "<div class='c_n76 fa fa-trash' title='" + TRANSLAT.dcard + "'></div>",
       qainhalt = new Array(),
   ...
   for ( THEINDEX = 0; THEINDEX < qalength; THEINDEX++ ) { qainhalt[THEINDEX] = new Object();
      ...
      if ( qandatxt ) { // Ammending or Uploaded -->> Walk through QA list preparing each camera, speaker and image.
         ...
         if ( ISEXTANT ) {
            ...
            if ( qandatxt[THEINDEX].s ) { // A sound is extant -->> show image of speaker and blue icon
               cardimag = "<img class='c_e33' src='" + HARDCODE.image + 166 + "'>";
               parlante = "<div style='color:#4D90FE' class='c_i27 fa fa-play' id='" +
                             THEINDEX + "s' title='" + TRANSLAT.rcord + "'>" +
                          "</div>";
            }
            ...
            if ( qandatxt[THEINDEX].i ) { // An image is extant -->> show it and blue icon
               camarita = "<div style='color:#4D90FE' class='c_f74 fa fa-camera' id='" +
                             THEINDEX + "i' title='" + TRANSLAT.qitxt + "'>" +
                          "</div>";
               cardimag = "<img class='c_e33' " +  // Randomize source for easy image editing
      ...
      contador = "<div class='c_e69'>" + parseInt( THEINDEX + 1 ) + "/" + qalength + "</div>";
      questext = "<textarea class='c_v26 notionary-pregunta' id='" + THEINDEX + "q'>" + qainhalt[THEINDEX].q + "</textarea>";
      resptext = "<textarea class='c_v26 notionary-risposta' id='" + THEINDEX + "a'>" + qainhalt[THEINDEX].a + "</textarea>";
      ellipsis = "<div class='fa fa-ellipsis-h'  id='" + THEINDEX + "x'></div>";

      cartinas += "<section class='c_w71' id='" + THEINDEX + "'>" +
                     "<div  class='c_v50' qaIndex='" + THEINDEX + "'>" +
                        "<figure class='c_n72'>" +
   ...
   if ( ISEXTANT ) {
      ...
      imaginer = "<img id='i_b118' notimage='" + nimgzahl + "' src='" + HARDCODE.image + nimgzahl + "'/>";
      nodelbtn = "<button id='i_d125'><span class='fa fa-check'></span>" + TRANSLAT.delek + "</button>";
      defqtime = NINFDATA[0].sperq ? NINFDATA[0].sperq : DEFSPERQ;
   }

   document.body.innerHTML = 
      "<div id='i_o126'>" +
            "<div id='i_i121' class='c_f55 fa fa-times'></div>" + imaginer +
            "<div id='i_v108'></div>" +
            "<div id='i_f112'></div>" +
            "<div id='i_113'>" +
               "<div id='i_f117'></div>" +
               ...
               "<div id='i_r101'></div>" +
               "<div id='i_i104'></div>" +
               "<div id='i_b97' class='c_d21'>0q</div>" +
            "</div>" +
            "<div id='i_e115'></div>" + uploader +
            "<button id='i_r120'><span class='fa fa-plus'> </span>" + TRANSLAT.nocht + "</button>" +
            "<button id='i_o98'><span class='fa fa-check'></span>" + TRANSLAT.savit + "</button>" + nodelbtn +
      "</div>" +
      "<div id='i_e128'></div>" +
      "<div id='i_h127'>" + cartinas + "</div>";

   f_m170( tlang );

   if ( !qandatxt ) f_r155("cs","","","","");  // Manually Writing or will Upload

   document.getElementById( "i_i121" ).onclick = function(e){ ISEXTANT = false; f_g86(); f_i87(); }

   if ( imaginer ) document.getElementById( "i_b118" ).onclick = function(e){ f_y151("ni"); }
   f_r160(nname,ndesc,"name",function(){ 
      document.getElementById( "i_c106" ).onkeydown = function(e){ f_g32(this);
         if ( this.value.match( TRANSLAT.nndef ) ) this.value = "";
      }
   });

   f_r160(nname,ndesc,"desc",function(){
      document.getElementById( "i_p109" ).onkeydown = function(e){ f_g32(this);
         if ( this.value.match( TRANSLAT.nddef ) ) this.value = "";
         document.getElementById( "i_x111" ).innerHTML = NDESCREG[3] - this.value.length + 1;
      }
   });
   ...
   if ( ISEXTANT ) {
      ...
      deletion = document.getElementById( "i_d125" );
...
function f_j173( qainhalt, highlite ){
   ...
   textares = document.getElementsByClassName( "c_v26" );
   ...
   garbages = document.getElementsByClassName( "c_n76" );
...
function f_t174(){
   var xoipopup = document.getElementById( "i_e128" ),
       tripdots = document.getElementsByClassName( "fa-ellipsis-h" );
   ...
   for ( r = 0; r < THEINDEX; r++ ) {
      ...
      speaker.onclick = function( e ){
         ...
         f_x50("soundHoch", f_p146("qs") +
            "<span id='i_k34' monindex='" + opiid + "'></span>" +
            "<div id='qsphp' class='c_t10'></div>",
            function(){
...
function f_h176(ncold,spold,npold,nnold,ndold,newAR,oldAR,tlold){
   ...
   notname  = document.getElementById( "i_c106" );
   notdesc  = document.getElementById( "i_p109" );
   pictobox = document.getElementById( "i_o105" );
   ...
   tlnew = document.getElementById( "i_q116" ).getAttribute("tgetlang");
...
function f_j177(oldnn,newAR,oldAR,testtype){
   ...
   edisendo = document.getElementById( "i_o98" );
...
function f_t178(nncur,nccur,spcur,ndcur,newAR,oldAR,slang,testtype){
   ...
   edit_NN  = document.getElementById( "i_c106" );
   edit_ND  = document.getElementById( "i_p109" );
   pictobox = document.getElementById( "i_o105" );

   if ( pictobox.checked ) { picto = true; for ( i = 0; i < THEINDEX; i++ ) newAR[i].q = newAR[i].a; }

   tlang = document.getElementById( "i_q116" ).getAttribute("tgetlang");
...
function f_y180(){
   ...
   f_m121( "probs", function(){
      f_z24( document.getElementById( "i_q73" ) );
      document.getElementById( "i_x87" ).onclick = function(e){ f_g86(); f_i87(); }
      f_y182();
   });
}
function f_x181(rottgrun){
   var gutPercent = ( 100 * KORREKTE ) / ( PENANCES * PROBZAHL ),
       gutbarein = document.getElementById( "i_r85" ),
...
function f_y182(){
   ...
   reptile  = document.getElementById( "i_b74" );
   xampicto = document.getElementById( "i_f77" );
   xamqtext = document.getElementById( "i_l76" );
   xamxoice = document.getElementById( "i_m78" );
   xoices = f_q129(
   ...
   for ( btn = 0; btn < 5; btn++ ) 
      buttonsMarkup += "<button id='reco" + btn + "' class='c_k56'>" + xoices[ btn ] + "</button>";
