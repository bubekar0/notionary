...
<?php
   ...
   require_once "../php/cssphp.php";
?>
body{ margin:0px; padding:0px; overflow-x:hidden; color:black; font-family:Futura, Calibri, sans-serif,monospace; }
...
.notionary-plainnotion  { position:relative; display:inline-table;
                          width:92%; max-width:<?php echo $BLG_IMG_W; ?>px !important; height:210px;
...
/* SKELETON */
#anonHeadroom       { height:165px; overflow:hidden; border-bottom:1px solid #ddd; }
   #anonHeadtops    { height:45px; overflow:hidden; }
...
#examBarOuter { position:absolute; left:15%; width:70%; height:35px; <?php mozart("box-shadow","1px 2px 3px $hardGrau"); ?>; }
...
#examLifehold { position:absolute; top:140px; left:15%; width:70%; height:5px; border:1px solid black; <?php myrad("10px"); ?>; }
...
#profileZentralHold .notionary-fieldset { position:relative; left:5%; width:90%; height:45px; margin:2px auto; 
...
#profLangmenu { top:105px; right:10px; display:none; <?php fontana("normal","900","1.2","2"); ?>; }
...
.notionary-trophies { display:inline-block; width:80px; height:30px; margin:5px; }
.notionary-trophies span { float:left; font-size:30px; <?php txtsh123($softGrau);?>; }


#userSettings { position:absolute; left:30%; min-width:50px; font-size:45px; text-align:center; cursor:pointer; }
#userEscritor { position:absolute; left:50%; min-width:50px; font-size:45px; text-align:center; cursor:pointer; }
...
#rootMenuclik { position:absolute; left:75%; min-width:50px; font-size:45px; text-align:center;
                cursor:pointer; color:red; <?php txtsh123($softGrau);?>; }
#rootMenulist { top:58px; right:5%; display:none; max-width:600px; <?php fontana("normal","900","1.3","2"); ?>; }
