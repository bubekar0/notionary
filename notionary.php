...
$dispatch = [
   'dopdf' => function() { dopdf($_REQUEST['was'] ?? null); },
   'cacha' => function() { cacha($_REQUEST['was'] ?? null); },
   'mudoc' => function() { mudoc($_REQUEST['was'] ?? null); },
   'ninfo' => function() { ninfo(); },
   'mixqa' => function() { mixqa($_REQUEST['was'] ?? null); },
   'busca' => function() { busca($_REQUEST['was'] ?? null); },
   'isusr' => function() { isusr(); },
   'known' => function() { known(); },
   'nuser' => function() { nuser(); },
   'sinfo' => function() { sinfo($_REQUEST['was'] ?? null); },
   'uinfo' => function() { uinfo(); },
   'linfo' => function() { linfo($_REQUEST['was'] ?? null); },
   'ibyid' => function() { ibyid($_REQUEST['was'] ?? null); },
   'sbyid' => function() { sbyid($_REQUEST['was'] ?? null); },
   'pbyid' => function() { pbyid($_REQUEST['was'] ?? null); },
];
