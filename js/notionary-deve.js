...
function showAvatar(elementID,clickCBK){
   ...
   var avatarElement = document.getElementById(elementID);
       USERBILD = HARDCODE.image + "101" +  "&r=" + Math.random( )* 100; // default: Notionary owl
...
function bindRecorderGuts(inits,nname,frage,currs){
   ...
   recobtn.onclick = function(){
      ...
      if ( navigator.mediaDevices && navigator.mediaDevices.getUserMedia ){
         ...
         }).catch(function(){ timedNotiz("Microphone access denied"); });
      } else timedNotiz("Recording not supported in this browser");
   }
