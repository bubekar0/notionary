...
window.onresize = function(){ // Resize Exam with Browser
   ...
   bottxt = document.getElementById( "i_s5" );
   txtcon = document.getElementById( "i_s2" );
   if ( MOBILE ) fntsiz = 18;
...
function f_g2(){
   ...
   document.body.innerHTML = "<img id='i_j6' src='" + PARAM.image + "1'/>";
/*
   logo2show = "Web Design";
   document.body.innerHTML =
      "<img id='i_j6' src='" + PARAM.image + "1'/>" +
      "<span id='i_m3'>" + logo2show + "</span>" +
         "<div id='i_h1'></div>" +
      "<div id='i_s2' class='animated zoomIn'>" + 
         f_i3() + f_t4() + f_m5() +
      "</div>" +
      "<div id='noview'>" +
...
function f_i3(){
   ...
   return("<ul id='i_d11'>" +
            "<li class='c_n2'>" + // MenuHeader
               "<a><span class='fa fa-bars'></span>&nbsp;&nbsp;&nbsp;Web Software</a>" +
               "<ul class='c_m1'>" + // Contents
                  "<li><a id='i_g7'>HTML5 & CSS3</a></li>" +
                  "<li><a id='ajax'>AJAX</a></li>" +
                  "<li><a id='i_k4'>" + XLATE.adapt + "</a></li>" +
                  "<li><a id='yui'>Mini-Code</a></li>" +
                  "<li><a id='i_b12'>Extras</a></li>" +
               "</ul>" +
            "</li>" +
            "<li class='c_n2'>" +
...
function f_o6(){
   ...
   var marea = document.getElementById( "i_x8" ),
       thisOption = document.getElementById( "i_g7" );
...
function f_g8(){
   ...
   var marea = document.getElementById( "i_x8" ),
       thisOption = document.getElementById( "i_k4" );
   thisOption.onclick = function(e){
...
function f_o10(){
   ...
   var marea = document.getElementById( "i_x8" ),
       thisOption = document.getElementById( "i_b12" );
   thisOption.onclick = function(e){
...
function f_m15(){
   ...
   var marea = document.getElementById( "i_x8" ),
       thisOption = document.getElementById( "i_a9" );
   thisOption.onclick = function(e){
...
function f_q21(){
   ...
   var marea = document.getElementById( "i_x8" ),
       thisOption = document.getElementById( "i_10" );
   thisOption.onclick = function(e){
